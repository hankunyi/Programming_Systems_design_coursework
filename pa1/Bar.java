...
public class Bar {
   ...
   */
   public void draw(Graphics2D g2) {
	   ...
	   widthOfLabel = (int)Math.round(labelBounds.getWidth());
	   heightOfLabel = (int)Math.round(labelBounds.getHeight());
	   g2.setColor(Color.BLACK);
	   g2.drawString(bar_label,x-(widthOfLabel-w)/2,y );
	   g2.setColor(bar_color);
	   Rectangle body = new Rectangle(x,y-h-heightOfLabel,w,h);
	   g2.draw(body);
	   g2.fill(body);
